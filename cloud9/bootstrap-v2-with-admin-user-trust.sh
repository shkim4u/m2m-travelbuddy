...
aws cloud9 create-environment-ec2 --name cloud9-workspace --instance-type m5.4xlarge --image_id amazonlinux-2-x86_64 --subnet-id "${SUBNET_ID}" --connection-type CONNECT_SSM --automatic-stop-time-minutes 10080
