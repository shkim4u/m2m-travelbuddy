module "lambda_query_result" {
  ...
  description   = "Amazon Bedrock Chatbot Query Result Lambda function"
  ...
  environment_variables = {
    ...
    indexName = var.call_log_index_name
  }
}
...
resource "aws_lambda_permission" "allow_api_gateway" {
  ...
  function_name = module.lambda_query_result.lambda_function_name
