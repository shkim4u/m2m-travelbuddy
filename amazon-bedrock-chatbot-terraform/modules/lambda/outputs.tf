...
output "chat_ws_lambda_function_arn" {
  value = module.lambda_chat_ws.lambda_function_arn
}
...
output "chat_ws_lambda_function_alias_name" {
  value = module.lambda_chat_ws.lambda_function_alias_name
}
