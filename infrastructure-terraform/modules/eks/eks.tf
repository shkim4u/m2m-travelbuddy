...
module "karpenter" {
  ...
  # (CAUTION) DO NOT use depends_on here because it will cause the following error:
  # "new karpenter policy attachment fails" with "for_each".
  # https://github.com/terraform-aws-modules/terraform-aws-eks/issues/2742
  #  depends_on = [module.eks, time_sleep.this]
